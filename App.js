...
const styles = StyleSheet.create({
  ...
  homeKpiRow: { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,0.12)', borderRadius: 14, overflow: 'hidden' },
  homeKpi: { flex: 1, paddingVertical: 12, alignItems: 'center' },
  homeKpiVal: { fontSize: 18, fontWeight: '900', color: C.white, letterSpacing: -0.5 },
  homeKpiLabel: { fontSize: 10, color: 'rgba(255,255,255,0.65)', marginTop: 2, fontWeight: '500' },
  ...
  jobCard: { backgroundColor: C.white, borderRadius: 14, padding: 14, marginBottom: 10, shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 6, elevation: 2 },
